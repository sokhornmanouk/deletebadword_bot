...
"fuck",
  ...
  "💦","រួមភេទ","មេជីវិត","tver knea","ធ្វើគ្នា","រួមដំណេក","dak jol","ដាក់ចូល","វៃ","banh terk","kikilu","ers","គី គី លូ","ស ក្ដាប់","rg 6","wtf","fck","ចុយ",
    ...
    "ក្តរ",
    "ក្តោរ",
    "កដរ","ចុយ", "ជុយ", "ចួយ", "ចុយគ្នា", "ចុយម៉ែ", "ចុយមី", "ចុយអា", "ចុយស្រី", "ចុយប្រុស", "ចុយគូថ", "ក្ដ", "ក្ត", "ក្តរ", "ក្តោរ", "កដរ", "កដោរ", "សក្ត", "សក្ដ", "ស ក្ដាប់", "សក្តាប់", "សក្ដាប់", "សក្តរ", "លឹង្គ", "លិង្គ", "ពងក្ត", "ពងក្ដ", "ពងក្តរ", "ពងក្ដរ", "ពងស្វាស", "ស្វាស", "ទឹកកាម", "មេជីវិត", "បាញ់ទឹក", "បាញ់ទឹកកាម", "បាញ់ក្នុង", "បាញ់ក្រៅ", "បាញ់លើមុខ", "ដាក់ចូល", "ដាក់ក្នុង", "ញាត់ចូល", "ធ្វើគ្នា", "ធ្វើសិច", "រួមភេទ", "រួមដំណេក", "រួមរ័ក", "សិច", "សុដន់", "ដោះធំ", "ច្របាច់ដោះ", "លិទ្ធក្ត", "លិទ្ធក្ដ", "លិទ្ធដោះ", "គូថ", "រន្ធគូថ", "ខ្លុយ", "ខ្លុយជៀន", "កណ្ដួយ", "កណ្តួយ", "កន្ដួយ", "កន្តួយ", "កណ្ដុយ", "កណ្តុយ", "យោនី", "ប្រដាប់ភេទ", "ប្រដាប់ភេទប្រុស", "ប្រដាប់ភេទស្រី", "អាសអាភាស"
